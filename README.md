## SfGradientView Customization Sample

This repository contains sample to customize the [Syncfusion Xamarin.Forms Gradient View](https://help.syncfusion.com/xamarin/gradient-view/getting-started) control.
